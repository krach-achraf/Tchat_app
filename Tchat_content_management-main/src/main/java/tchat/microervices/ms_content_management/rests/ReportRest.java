...
public class ReportRest {
    ...
    @PutMapping("/user/lock/{userId}/{username}")
    public ResponseEntity<String> lockUser(@PathVariable Long userId, @PathVariable String username) {
        log.info("ReportRest : lock the user " + userId);
        return reportService.lockUser(userId, username);
    }
}
